...
//     msgDao.dropTable(sqLiteDatabase);
        ...
        msgDao.setCreateIndexes(new String[]{"CREATE INDEX INDEX_NAME  ON " + msgDao.tableName + " (" + getRoomKey() + ");"});
        msgDao.setCreateIndexes(new String[]{"CREATE INDEX INDEX_NAME2  ON " + msgDao.tableName + " (" + getKey() + ");"});
        msgDao.setCreateIndexes(new String[]{"CREATE INDEX INDEX_NAME3  ON " + msgDao.tableName + " (" + getRoomKey(), getTimestampKey() + ");"});
